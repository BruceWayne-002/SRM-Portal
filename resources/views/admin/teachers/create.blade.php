...
<nav class="navbar navbar-dark bg-primary mb-3">
  <div class="container-fluid d-flex align-items-center">
    <a href="{{ route('admin.teachers.index') }}" class="btn btn-light btn-sm me-2">
      <i class="bi bi-arrow-left"></i> Back
    </a>
    <span class="navbar-brand mb-0">Add New Teacher</span>
  </div>
</nav>
...
<div class="container mt-4">
  ...
  <div class="col-md-6 mb-3">
    ...
    <small class="text-muted">Allowed formats: JPG, JPEG, PNG, GIF, etc.</small>
  </div>
</div>
