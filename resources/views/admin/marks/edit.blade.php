...
@section('title', 'Edit Marks - ' . ($exam->subject_name ?? $exam->subject->name ?? 'Exam'))

@section('main')
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-warning">
            <i class="fas fa-edit me-2"></i>Edit Marks - {{ $exam->subject_name ?? $exam->subject->name ?? 'Exam' }}
        </h2>
        <div>
            <a href="{{ route('admin.marks.show', $exam->id) }}" class="btn btn-info me-2">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-warning">
            <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Marks</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.marks.update', $exam->id) }}" id="marksForm">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select" required>
                            <option value="draft" {{ isset($status) && $status == 'draft' ? 'selected' : '' }}>Save as Draft</option>
                            <option value="published" {{ isset($status) && $status == 'published' ? 'selected' : '' }}>Publish Immediately</option>
                        </select>
                    </div>
                    <div class="col-md-8">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fas fa-save me-1"></i> Update Marks
                                            </button>
                                        </div>
                                    </div>
                                </td>
