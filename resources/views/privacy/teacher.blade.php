...
<div class="container py-5">
    <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
        ...
        <ol class="breadcrumb" style="background-color:#E8D8FF; padding:10px;">
            <li class="breadcrumb-item">
            <a href="{{ route('teacher.dashboard') }}" style="color:#640d3c; text-decoration:none;">Dashboard</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page" style="color:#333;">Privacy and support</li>
        </ol>
        </nav>
        <div class="card-body p-4">
            ...
            <ul class="list-group mb-4">
                ...
                <li class="list-group-item">Teachers can access only their own classes and assigned student information. Sensitive data is restricted to authorized staff only.</li>
            </ul>
            ...
            <ul class="list-group mb-4">
                <li class="list-group-item">Teachers have the right to update their profile, manage their information, and request support for any data concerns.</li>
            </ul>

            {{-- Regular Updates --}}
            <h4 class="fw-bold text-primary mb-3">5. Regular Updates</h4>
            <ul class="list-group">
                <li class="list-group-item">The app is regularly updated with the latest security features to prevent data leaks, hacking, or misuse.</li>
            </ul>
        </div>
    </div>
</div>
